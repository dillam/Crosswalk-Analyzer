...
def visualize_boxes_and_labels_on_image_array(current_frame_number,
                                              ...
                                              scores,
                                              category_index,
					                          targeted_objects=["person", "car", "truck"],
                                              y_reference=None,
                                              deviation=None,
                                              instance_masks=None,
                                              keypoints=None,
  ...
  for box, color in box_to_color_map.items():
    ...
    for object in targeted_objects:
        if(mode == 1 and targeted_objects == None):
          counting_mode = counting_mode + str(display_str_list)

        elif(mode == 1 and object in display_str_list[0]):
          counting_mode = counting_mode + str(display_str_list)

        if ((targeted_objects != None) and (object in display_str_list[0])):
                if instance_masks is not None:
